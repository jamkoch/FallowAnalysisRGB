...
write.csv(df.crop.sum.eco ,
         "~/csv/Area_Crop[ecoregions].csv" ,
          row.names = F)
write.csv(df.fallow.sum.eco ,
          "~/csv/Area_Fallow[ecoregions].csv" ,
          row.names = F)
write.csv(df.area.fallow.eco ,
          "~/csv/Percent_Fallow_TotalYear[ecoregions].csv" ,
          row.names = F)
write.csv(df.max.extent.fallow.eco ,
          "~/csv/Percent_Fallow_MaxExtent[ecoregions].csv" ,
          row.names = F)
...
write.csv(df.crop.sum.state ,
          "~/csv/Area_Crop[states].csv" ,
          row.names = F)
write.csv(df.fallow.sum.state ,
          "~/csv/Area_Fallow[states].csv" ,
          row.names = F)
write.csv(df.area.fallow.state ,
          "~/csv/Percent_Fallow_TotalYear[states].csv" ,
          row.names = F)
write.csv(df.max.extent.fallow.state ,
          "~/csv/Percent_Fallow_MaxExtent[states].csv" ,
          row.names = F)
